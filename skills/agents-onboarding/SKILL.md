...
| 8 | **Import do agente** (`agent_import`; padrão **Esther**/Clínica IndicaFácil, vendorado em `samples/agents/esther-clinica-indicafacil.json`) + embedding por-tenant + reindex/retry da KB | [`references/08-agent-import.md`](references/08-agent-import.md) |
