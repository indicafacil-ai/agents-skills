...
- **Pro privado:** nunca publicar o repo (`nicolasdasilvaesilva/agents-pro`), a imagem, ou trechos exclusivos do Full em local público.
...
- **Estilo:** PT-BR com acentuação; sem em-dash; marca `Indica Fácil` (slugs `indica-facil`); comentários só com tag.
